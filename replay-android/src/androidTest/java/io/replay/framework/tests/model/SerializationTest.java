...
public class SerializationTest extends AndroidTestCase {
    ...
    public void testSerializeReplayRequest() throws Exception {
        ReplayRequest request = new ReplayRequest(RequestType.EVENTS, new ReplayJsonObject());
    ...
    public void testSerializeReplayJob() throws Exception {
        TestReplayJob job = new TestReplayJob(new ReplayRequest(RequestType.EVENTS, new ReplayJsonObject()));
