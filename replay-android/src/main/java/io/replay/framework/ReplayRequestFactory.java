...
class ReplayRequestFactory {
    ...
    static void mergePassiveData(ReplayRequest request){
        ...
        if (!Util.isNullOrEmpty(mPrefs.getDistinctID())) {
    ...
    static ReplayRequest requestForEvent(String event, Object... data)  {
        ...
        return new ReplayRequest(ReplayRequest.RequestType.EVENTS, json);
    }
    ...
    static ReplayRequest requestForTraits(Object... data) {
        ...
        return new ReplayRequest(ReplayRequest.RequestType.TRAITS, json);
    }
